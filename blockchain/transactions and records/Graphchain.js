...
const GraphChain = new Blockchain();
...
// Mine transaction
GraphChain.mineTransactions(holderKeyPair.getPublic("hex"));

// Prints out balance of both address
console.log("Your balance:", GraphChain.getBalance(holderKeyPair.getPublic("hex")));
console.log("Your girlfriend's balance:", GraphChain.getBalance(girlfriendWallet.getPublic("hex")));
